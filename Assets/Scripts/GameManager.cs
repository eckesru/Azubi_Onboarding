...
public class GameManager : MonoBehaviour
{
    ...
    private void InitializeGameScript() {
        ...
        AddDialogue("Vertriebsabteilung4", "Willkommen! Da bist du ja endlich.", "Ich werde dein Ausbilder sein.", "Wie du sicher schon weißt, verkaufen wir hier Fahrzeuge.", "Wie genau das funktioniert, wirst du die nächsten Wochen von mir lernen." , "Zunächst habe ich aber eine Bitte an dich.", "Hol mir bitte einen Kaffee aus der Küche.");
        ...
        AddDialogue("Vertriebsabsteilung10", "Gut gemacht.", "Als nächstes brauchst du einen Laptop.", "Bitte hole deinen Laptop bei der IT-Abteilung, am Ende des Flures ab.");
        AddDialogue("IT-Abteilung11", "Hey! Willkommen in der IT-Abteilung!", "Wir kümmern uns hier um die Technik im Büro.", "Du brauchst einen Laptop?", "Deinen Laptop findest du im Serverraum, rechts durch die Tür.");
        ...
        AddDialogue("Geschaeftsfuehrer20", "Genau diesen Golfschläger habe ich gebraucht.", "Gute Arbeiter sind mir sehr wichtig. Also streng dich immer weiter an.", "Ich habe jetzt einen wichtigen Termin, also zurück an die Arbeit!");
        AddDialogue("Vertriebsabteilung21", "Hast dich dem Manager vorgestellt?", "Der Manager kann etwas streng sein, er ist aber eigentlich ein lieber Kerl.", "Damit hast du alle Aufgaben abgeschlossen.", "Du hast nun die wichtigsten Bereiche im Büro kennengelernt. Klasse!","Du solltest jetzt Feierabend machen, den hast du dir verdient.", "Bis morgen!");
